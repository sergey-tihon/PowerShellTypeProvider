module FSPowerShell.PSRuntime.Hosted
...
type IPSRuntime =
    abstract member AllCmdlets  : unit -> PSInference.PSCommandLet[]
...
type PSRuntimeHosted(snapIns:string[]) =
    ...
    let cmdlets =
        ...
        |> Seq.map (fun cmdlet ->
                       let wrapper = PSInference.createPSCommandLet cmdlet
    ...
    interface IPSRuntime with
        ...
        member this.Execute(rawName,parameters:obj seq) =
            ...
            let tyOfObj = PSInference.getTypeOfObjects tys result

            let collectionConverter = 
                typedefof<PSInference.CollectionConverter<_>>.MakeGenericType(tyOfObj)
            ...
            | [|help|] ->
                let lines = 
                    ...
                    if description = null then [||] 
                        ...
                        description
                        |> PSInference.CollectionConverter<PSObject>.Convert
                        |> List.toArray
